    ...
    return (
        <div className="w-full flex justify-center items-center mt-10">
            <form onSubmit={handleSubmit} className="w-1/2 bg-purple-50 px-20 py-8 rounded-lg">
                <h3 className="text-3xl text-center ">User <span className='text-primary'>Cash Out </span></h3>
                ...
                <div className="mt-5 flex justify-center w-full">
                    ...
                    <input type="submit" className="w-fit  focus:outline-none px-4 py-3 bg-purple-500 text-white rounded-lg m" value={'Send Cashout Request'} />
                </div>
